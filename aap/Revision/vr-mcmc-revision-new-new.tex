...
\PVar_x \left[ \pi_{N}^n(f) \right] \leq \frac{C_1\pi(V)\|\tilde{f}\|^2_{V^{1/2}}}{n(1-\rho^{1/2})} + \mathcal{O}(\frac{1}{n^2(1-\rho^{1/2})})
\end{equation}
...
\[
S_1 \leq \frac{2}{n}C\pi(V)\|\tilde{f}\|^2_{V^{1/2}} + \frac{\rho^N C^2V(x)\left(\rho^NV(x) + 2\|\tilde{f}\|^2_{V^{1/2}}\right)}{n^2(1-\rho)}
\]
\begin{eqnarray*}
