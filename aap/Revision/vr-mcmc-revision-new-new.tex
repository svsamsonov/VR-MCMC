...
>>>>>>> 172505d014076ade3cffaefcdaa99eea32f50423
...
=======
 ...
 \pi(x) = \frac{1}{2\sqrt{(2\pi)^{d}|\Sigma|}} \left( \rme^{-\frac{(x-\mu)^T\Sigma^{-1}(x-\mu)}{2}} + \rme^{-\frac{(x+\mu)^T\Sigma^{-1}(x+\mu)}{2}}\right)
 \]
where $\mu \in \rset^d, \Sigma \in \rset^{d \times d}$ and $|\Sigma|$ is its determinant. The function $U(x)$ and its gradient are given by
>>>>>>> 172505d014076ade3cffaefcdaa99eea32f50423
\[
