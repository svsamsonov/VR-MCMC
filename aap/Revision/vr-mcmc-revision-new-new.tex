...
\[
\bar A_{q,k}=\argmin_{\psi\in\Psi}\mathsf{E}[|A_{q,k}(X_L)-\psi(X_L)|]^2
\]
...
\begin{equation}
\label{eq:bias_2}
\tvnorm{\pi - \pi_\gamma} < C_1\sqrt{\gamma}.
\end{equation}
