...
\begin{equation}
\label{eq:1_bound}
\PE \exp\left\{2u\gamma\sum_{k=N+1}^{N+n}\left(f(Y_k) - \PE_xf(Y_k)\right)\right\} \leq \exp\left\{\frac{16u^2 n\gamma \|f\|^2_{\text{Lip}}\left(1+\frac{N}{n}\right)(m+L)^2}{m^2L^2}\right\}
\end{equation}
