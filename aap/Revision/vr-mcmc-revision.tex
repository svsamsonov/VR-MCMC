...
\item[(H2)][\textbf{Convexity outside a ball}] There exist $K>0,$ $M>0$ and $m>0$ such that for any $x\not\in B_K(0)	$ and any $y\in \mathbb{R}^d$ it holds 
\begin{eqnarray*}
...
x\in\mathbb R^d
\end{eqnarray*}
for all \(\mathbf{k}\) with \(0<\|\mathbf{k}\|\leq  2.\) Moreover assume that there exist $K>0,$ $M>0$ and $m>0$ such that for any $x\not\in B_K(0)$ and any $y\in \mathbb{R}^d$ it holds
\[
\langle \nabla \mu(x)y,y\rangle \geq m\|y\|^2.
\]
...
\begin{eqnarray}
\label{eq:var-bound}
\mathsf{Var}\left[\left.\pi_{K,n}^{N}(f)\right|\mathcal G_N\right]\lesssim \frac{1}{\Gamma^2_{N+2,N+n+1}},
\end{eqnarray}
...
\section{Bounds for moments of  ULA}
For $\gamma>0$, the Markov kernel $R_\gamma$
...
\item[(H2)] There exist $K>0,$ $M>0$ and $m>0$ such that for any $x\not\in B_K(0)	$ and any $y\in \mathbb{R}^d$ it holds 
\begin{eqnarray*}
\langle D^2U(x)y,y\rangle \geq m\|y\|^2, \quad \|D^3 U(y)\| \leq M. 
\end{eqnarray*}
...
\end{eqnarray*}
Under assumptions (H1) and (H2), then for any bounded function $g$ on $\mathbb{R}^d$ 
we have
\begin{eqnarray*}
