...
\includegraphics[width=0.45\textwidth]{vr_cost_linear_gaussian.png}
\label{fig:subfig1}}
\qquad
\subfloat[Subfigure 2 list of figures text][$f(x)=\sum_{i=1}^d x^2_i$]{
\includegraphics[width=0.45\textwidth]{vr_cost_quadratic_gaussian.png}
\label{fig:subfig2}}
...
\centering
\subfloat[Subfigure 1 list of figures text][$f(x)=\sum_{i=1}^d x_i$]{
\includegraphics[width=0.45\textwidth]{vr_cost_linear_gmm.png}
\label{fig:subfig1}}
\qquad
\subfloat[Subfigure 2 list of figures text][$f(x)=\sum_{i=1}^d x^2_i$]{
\includegraphics[width=0.45\textwidth]{vr_cost_quadratic_gmm.png}
\label{fig:subfig2}}
...
\centering
\subfloat[Subfigure 1 list of figures text][$f(x)=\sum_{i=1}^d x_i$]{
\includegraphics[width=0.45\textwidth]{GMM_2d_lin_sum.png}
\label{fig:subfig1}}
\qquad
\subfloat[Subfigure 2 list of figures text][$f(x)=\sum_{i=1}^d x^2_i$]{
\includegraphics[width=0.45\textwidth]{GMM_2d_lin_sum_squares.png}
\label{fig:subfig2}}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.6\textwidth]{banana_shape.png}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.6\textwidth]{logreg_1st_order.png}
