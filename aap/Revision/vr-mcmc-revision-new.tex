...
\begin{align*}
\mathsf{E}\left[\sum_{j=1}^{q}\prod_{k=1}^{j}\alpha_{k}\left(\sum_{p=j+1}^{q+1}\prod_{k=j+1}^{p}\alpha_{k}\right)^{2}\right]  \leq \frac{e^{6\kappa\gamma^2 - 3\gamma\alpha}}{\left(1-e^{4\kappa\gamma^2 - 2\gamma\alpha}\right)\left(1-e^{2\kappa\gamma^2 - \gamma\alpha}\right)}
\end{align*}
