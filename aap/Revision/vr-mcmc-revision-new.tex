...
Thus we obtain
\begin{eqnarray*}
U(\theta) = \mathsf{Y}^T \mathsf{X} \theta + \sum_{i=1}^m \ln{\left(1 + \rme^{-\theta^T \mathsf{X}_i})} + \frac{1}{2\sigma^2} \left\|\mathbf{\theta}\right\|_2^2, \,\,
